...
class PublicSchoolSearchView(APIView):
    ...
    def get(self, request):
        from core.school_directory import allow_school_search, public_school_results

        if not allow_school_search(request):
            return Response(
        ...
        results = public_school_results(
            query,
            str(request.query_params.get("location") or ""),
        )
